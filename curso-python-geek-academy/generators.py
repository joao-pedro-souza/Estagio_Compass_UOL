...
print(getsizeof(923456688233))

print(getsizeof(True))

from sys import getsizeof

# Gerando uuma lista de números com List Comprehension
list_comp = getsizeof([x * 10 for x in range(1000)])

# Gerando uuma lista de números com Set Comprehension
set_comp = getsizeof({x * 10 for x in range(1000)})

# Gerando uuma lista de números com Dictionary Comprehension
...
# Eu posso iterar no Generator Expressiom? Sim!
