...
# OBS
# Se o usuário passar somente 1 argumento, este será atribuído ao parâmetro numero, e será calculado o quadrado deste nu´mero;
# Se o usuário passar 2 argumentos, o primeiro será atribuído ao parâmetro numero e o segundo ao parâmettro potencia. Então
...
def diz_oi():
    instrutor = 'Python' # Variávefl local
    return f'Oi {instrutor}'


print(diz_oi())

# OBS: Se tivermos uma variável local com o memso nome de uma global, a local terá preferência.
