...
Diferença entre Conjuntos (Set) e Mapas (Dicionários) em Python:
    - Um dicionáario tem chave/valor;
...
# Conjuntos não aceitam chaves duplicados, então temos 8 elementos
...
# {'Julia', 'Ana', 'Gustavo', 'Guilherme', 'Fernando', 'Patricia', 'Ellen', 'Pedro', 'Marcos'}
# unicos1 = estudantes_java.union(estudantes_python)
# {'Ana', 'Guilherme', 'Julia', 'Fernando', 'Gustavo', 'Pedro', 'Marcos', 'Patricia', 'Ellen'}
print(unicos1)
...
# Veja que alguns alunos que estuda Python também estudam Java.

# Gerar um conjunto de estudantes que estão em ambos os curso
