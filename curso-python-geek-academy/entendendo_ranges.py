...
OBS: valor_de_para não inclusive (início padrão 0, e passo de 1 em 1)
...
OBS: valor de parada não inclusive (início especificado pelo usuário, e passo especificado pelo usuário)
