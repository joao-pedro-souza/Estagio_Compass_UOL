...
- Dinâmico: Não posssuem tamanho  fixo; Ou seja, podemos criar a lista e simplesmente ir adicionando elemtentos;
...
# Podemos facilmete checar se determinado valor está contido na lista
num = 7
if num in lista4:
...
# OBS: Com append, nós só conseguimos adicionar 1 elemnto por vez
...
# Convertendo uma lista em uma lista string

lista6 = ['Programação', 'em', 'Python:', 'Essencial']
print(lista6)

# Abaixo estamos falando: Pega a lista6, coloca espaço entre cada elementto e transforma em uma string
curso = ' '.join(lista6)
print(curso)

# Abaixo estamos falando: Pega a lista6, coloca cifrão entre cada elementto e transforma em uma string
curso = '$'.join(lista6)
print(curso)

# Podemos realmente colocar qualquer tipo de dado em uma lista, inclusive misturando esses dados

lista6 = [1, 2.34, True, 'Geek', '4', [1, 2, 3], 45345345345]
print(lista6)
print(type(lista6))
...
# Fazer acesso aos elementos de forma indexada diversa
# Para entender melhor o índice  negativo, pense na lista como um círculo, onde
# o final de um elemento está ligado ao iníco da lista
...
# Outros métodos nãao tão importantes mas também úteis
...
print(numeros.index(8, 3, 6)) # Buscar o índice do valor 8, entre os índices 3 e 8
...
# Veja que utilizamos a cópia via atribuição e copiamos os dados da lista para a nova a lista, mas
# após realizar modificação em uma das listas, esta modificação se refletiu em ambas as listas.
