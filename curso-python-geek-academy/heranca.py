...
BOS: Com a herança, a partir de uma classe existente, nós extendemos outra classe
...
# Perguntar: Existe alguma entidade génerica o suficiente para encapsular os atributos
...
class Funcionario(Pessoa):
    ...
    def __init__(self, nome, sobrenome, cpf, matricula):
        super().__init__(nome, sobrenome, cpf) # Forma comum de acessar os dados da super classe
        self.__matricula = matricula
