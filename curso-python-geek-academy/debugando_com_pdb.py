...
# no ínicio do arquivo. Por isso, ao invés de colocarmos o import do pdb no início do arquivo,
...
# * A partir do Python 3.7, não é mais necessário importar a bilioteca pdb, pois o comando de debug foi
