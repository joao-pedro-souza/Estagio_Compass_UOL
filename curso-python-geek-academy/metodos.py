...
não é aconselhado. Python posssui vários métodos com esta forma de nomenclatura e pode ser que mudemos o comportamneto
...
Usuario.conta_usuarios() # Forma corretaa
